...
const ptBR: Dict = {
  ...
  'effect.compute': '+{pct}% Compute',
  'effect.token': '+{pct}% Tokens',
  'effect.verbs': '+{pct}% verbos',
  'effect.window': '+{n} contexto',
  'effect.halluc': '−{pct}% alucinação',
  'effect.slots': '+{n} slots',
  'effect.data': 'coleta passiva de Dados',
...
const enUS: Dict = {
  ...
  'effect.compute': '+{pct}% Compute',
  'effect.token': '+{pct}% Tokens',
  'effect.verbs': '+{pct}% verbs',
  'effect.window': '+{n} context',
  'effect.halluc': '−{pct}% hallucination',
  'effect.slots': '+{n} slots',
  'effect.data': 'passive Data collection',
